			...
			try{
				...
				if ($status == 'approved') {
					...
					if($request_type == 2){
			            ...
			            $balance = $receiver_balance - $amount;
						$statement = 'Your request to withdraw $'.$amount.' out of your Nexus Insights account was approved. Funds have been deposited to your choosen payment option.<br/> Thank you for investing with us';
