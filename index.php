  ...
  <div class="page-wrapper">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center mb-none-30">
          ...
          foreach ($investment_plans as $investment_plan) :
            $fade_in = ($index == 2 || $index == 4) ? "fadeInDown" : "fadeInUp";
            $plan_focus = ($index == 2 || $index == 4) ? "pricing-active" : "";
            $icon_image = ($index == 2 || $index == 4) ? "BitcoinIcon5.png" : "BitcoinIcon4.png";
            $btn_class = ($index == 2 || $index == 4) ? "btn--white" : "btn--secondary";
            ...
            $duration = ($investment_plan->duration <= 4) ? ($days * 24 . " Hours") : ($days . " Days");
          ?>
    ...
    <section class="pt-120 pb-120 overlay--radial bg_img" data-background="assets/images/bg/bg-3.jpg">
      <div class="container">
        ...
        <div class="row justify-content-center mb-none-30">
          ...
          <div class="col-xl-3 col-sm-4 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                <div class="choose-card__icon"><i class="las la-lock"></i></div>
                <h4 class="choose-card__title">High reliability</h4>
              </div>
              <p>We are trusted by a huge number of people. We are working hard constantly to improve the level of our security system.</p>
            </div>
          </div>
          <div class="col-xl-3 col-sm-4 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                ...
                <h4 class="choose-card__title base">Anonymity</h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                <div class="choose-card__icon"><i class="las la-shipping-fast"></i></div>
                <h4 class="choose-card__title base">Quick Withdrawal</h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                ...
                <h4 class="choose-card__title base">Referral Program</h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                ...
                <h4 class="choose-card__title base">24/7 Support</h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                ...
                <h4 class="choose-card__title base">Dedicated Server</h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                ...
                <h4 class="choose-card__title base">SSL Secured</h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-md-6 mb-30">
            <div class="choose-card border-radius--5">
              <div class="choose-card__header mb-3">
                ...
                <h4 class="choose-card__title base">DDOS Protection</h4>
              </div>
            ...
            <div class="accordion cmn-accordion" id="accordionExample">
              <div class="card">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                  <div class="card-body">
                    Deposit and withdrawal are available at any time. Be sure that your funds are not used in any ongoing trade before the withdrawal. The available amount is shown in your dashboard.
                  </div>
                </div>
              </div>
              <div class="card">
              ...
              <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                  <div class="card-body">
                    You will get an automatic notification once we send the funds, and you can always check your transactions or account balance.
                  </div>
                </div>
              </div>
              <div class="card">
          ...
          <div class="col-lg-12">
            <div class="testimonial-slider">
              ...
              <div class="single-slide">
                <div class="testimonial-card">
                  <div class="testimonial-card__content">
                    <p>The best investment that I can recommend to anyone that wants to trade and get back profit.</p>
                  </div>
                  <div class="testimonial-card__client">
                    <div class="thumb">
                  ...
                  <table class="table style--two">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        echo '<div class="col-lg-4 col-xl-3 col-sm-6"><div class="transaction-item"><div class="transaction-header"><h5 class="title">No Transaction Yet</h5></div></div></div>';
                      }
                      ?>
                    </tbody>
                  </table>
        ...
        <div class="row justify-content-center mb-none-30">
          <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="investor-card border-radius--5">
              ...
              <div class="investor-card__content">
                <h6 class="name">Abdul Manaf Abbasi</h6>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="investor-card border-radius--5">
              ...
              <div class="investor-card__content">
                <h6 class="name">Jack Wei</h6>
                <span class="amount f-size-14">Investment - $4,500,600</span>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="investor-card border-radius--5">
              ...
              <div class="investor-card__content">
                <h6 class="name">Zhang Wei Chen</h6>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="investor-card border-radius--5">
              ...
              <div class="investor-card__content">
                <h6 class="name">Wang Yang</h6>
                <span class="amount f-size-14">Investment - $850,000</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="pb-120">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8">
            <div class="cta-wrapper bg_img border-radius--10 text-center" data-background="assets/images/bg/bg-2.jpg">
              <h2 class="title mb-1">Get Started Today With Us</h2>
              <p>This is a reliable money-making platform! Invest for the future in a stable platform and make fast money. We guarantee the fastest returns and the security of your investment.</p>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              ...
              <p>We accept all major cryptocurrencies and digital payment methods to make your investment process easier.</p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <div class="payment-slider">
              <div class="single-slide">
                <div class="brand-item"><div class="img-1"></div></div>
              </div>
              <div class="single-slide">
                <div class="brand-item"><div class="img-2"></div></div>
              </div>
              <div class="single-slide">
                <div class="brand-item"><div class="img-3"></div></div>
              </div>
              <div class="single-slide">
                <div class="brand-item"><div class="img-4"></div></div>
              </div>
              <div class="single-slide">
                <div class="brand-item"><div class="img-5"></div></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              ...
              <p>Explore our latest insights on investment strategies, blockchain technology, crypto-trading, and mining.</p>
            </div>
          </div>
        </div>
        <div class="row justify-content-center mb-none-30">
          ...
          foreach (array_slice($news, 0, 3) as $new) :
            $tag1 = $index == 1 ? "Coin" : ($index == 2 ? "Cryptocurrency" : "Bitcoin");
            $tag2 = $index == 1 ? "Apps" : "Tech";
          ?>
            <div class="col-lg-4 col-md-6 mb-30">
              <div class="blog-card">
                <div class="blog-card__thumb">
                  <img src="admin/images/<?= htmlspecialchars($new->photo); ?>" loading="lazy" alt="image">
                </div>
                <div class="blog-card__content">
                  <h4 class="blog-card__title mb-3"><a href="news-detail.php?id=<?= $new->id; ?>&title=<?= $new->slug; ?>"><?= substrwords($new->title, 50); ?></a></h4>
                  <ul class="blog-card__meta d-flex flex-wrap mb-4">
                    <li><a href="news-detail.php?id=<?= $new->id; ?>&amp;title=<?= $new->slug; ?>"><?= $tag1; ?>, <?= $tag2; ?></a></li>
                    <li><i class="fas fa-calendar"></i><a href="#"><?= $new->posted; ?></a></li>
                  </ul>
                  <p><?= substrwords($new->short_details, 150); ?></p>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-lg-0 mt-4">
                  <form class="subscribe-form">
                    ...
                    <button class="subscribe-btn"><i class="fas fa-envelope"></i></button>
                  </form>
                </div>
              </div>
            </div>
