	...
	if(isset($_POST['complete'])){
		...
		$act_time = date('Y-m-d h:i A');
			...
			try{
				...
				$stmt = $conn->prepare("INSERT INTO request (user_id, trans_date, type, amount, status, payment_mode) VALUES (:user_id, :trans_date, :type, :deposit_amount, :status, :payment_mode)");
				$stmt->execute(['user_id'=>$user_id, 'trans_date'=>$trans_date, 'type'=>1, 'deposit_amount'=>$deposit_amount, 'status'=>$status, 'payment_mode'=>$payment_mode]);
					                                        ...
					                                        <tbody>
					                                            <tr>
					                                                <td style='padding: 10px 0 13px 0;' align='left'>
					                                                    <a href='https://www.nexusinsights.com'>
					                                                        <img
					                                                            class='m_4873022159957722792jecl-Icon-img CToWUd'
					                                                            style='display: block;'
					                                                            src='https://www.nexusinsights.com/assets/images/logo-dark.png'
					                                                            alt='prime-logo'
					                                                            width='300'
					                                                            height='60'
					                                                            border='0'
					                                                                                ...
					                                                                                <td style='padding: 16px 10px 0;'>
					                                                                                    ...
					                                                                                    <p style='font-size: 13px; line-height: 20px; color: #666666; margin: 0px; text-align: left;' align='center'>
					                                                                                        ...
					                                                                                        <span style='color: #000000;'>
					                                                                                            ...
					                                                                                            <strong><a style='color: #000000;' href='mailto:fraud@nexusinsights.com'>fraud@nexusinsights.com.</a> </strong>
					                                                                                        </span>
					                                                                                    </p>
					                                                                                </td>
					                                                                            </tr>
					                                                        ...
					                                                        <tbody>
					                                                            <tr>
					                                                                <td style='font-size: 12px; line-height: 16px; color: #4b4b4b; padding: 20px 0; margin: 0 auto;' align='center'>
					                                                                    *This email account is not monitored. Reply to <a href='mailto:info@nexusinsights.com'>info@nexusinsights.com</a> if you have any query.
					                                                                    <a style='text-decoration: underline; color: #085ff7;' href='https://www.nexusinsights.com/investment'> View Our Available Plans </a>
					                                                                </td>
					                                                            </tr>
					                                                        </tbody>
					                                                    </table>
					                                                        ...
					                                                        <tbody>
					                                                            ...
					                                                            <tr style='height: 10px;'>
					                                                                <td class='m_4873022159957722792j-6' style='padding: 15px 0px 25px; height: 10px;' align='center'>
					                                                                    <span class='m_4873022159957722792j-5'><a style='text-decoration: underline; color: #085ff7;' href='https://www.nexusinsights.com'>Home</a>|</span>
					                                                                    <a class='m_4873022159957722792j-1' style='text-decoration: underline; color: #085ff7;' href='https://www.nexusinsights.com/about'>About</a>
					                                                                    <span class='m_4873022159957722792j-5'>|</span>
					                                                                    <a class='m_4873022159957722792j-2' style='text-decoration: underline; color: #085ff7;' href='https://www.nexusinsights.com/investment'>Plans</a> <br />
					                                                                    <a class='m_4873022159957722792j-3' style='text-decoration: underline; color: #085ff7;' href='https://www.nexusinsights.com/news'> News </a>
					                                                                    <span class='m_4873022159957722792j-5'>|</span>
					                                                                    <a class='m_4873022159957722792j-4' style='text-decoration: underline; color: #085ff7;' href='https://www.nexusinsights.com/contact'>Contact</a>
					                                                                </td>
					                                                            </tr>
					                                                        </tbody>
					                                                    </table>
