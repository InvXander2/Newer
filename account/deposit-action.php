...
if (isset($_POST['complete'])) {
    ...
    try {
                                                                                            ...
                                                                                            <td style='padding: 16px 10px 0;'>
                                                                                                ...
                                                                                                <p style='font-size: 13px; line-height: 20px; color: #666666; margin: 0px; text-align: left;' align='center'>
                                                                                                    <span style='color: #000000;'>
                                                                                                        Your request to deposit $" . htmlspecialchars($deposit_amount) . " has been received. Do ensure to pay the requested amount to the wallet provided on the address shown to you. Funds will
        ...
        try {
            ...
            $adminMail->isHTML(false); // Plain text for admin notification
            $msg = $investor_name . " just requested a deposit of $" . $deposit_amount . ". Login to the admin panel to review.";
            $adminMail->Subject = 'New Deposit Request - ' . $settings->siteTitle;
            $adminMail->Body = wordwrap($msg, 70);
            $adminMail->send();
        } catch (Exception $e) {
