...
try {
    ...
    $percent_loss_gain = ($previous_balance > 0) ? (($latest_balance - $previous_balance) / $previous_balance) * 100 : 0;
} catch (PDOException $e) {
...
try {
    ...
    error_log("Active investments data: " . print_r($row5, true));
} catch (PDOException $e) {
...
try {
    ...
    $stmt1 = $allplanQuery->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
                        ...
                        <div class="card-body">
                            <ul class="list-group custom-list-group mb-n3">
                                ...
                                try {
                                    ...
                                    $newQuery->execute();
                                    $news = $newQuery->rowCount() ? $newQuery->fetchAll(PDO::FETCH_ASSOC) : [];
                                    $index = 1;
                                    foreach ($news as $new):
                            ...
                            <div class="analytic-dash-activity" data-simplebar>
                                <div class="activity">
                                    ...
                                    try {
                                        ...
                                        $actrow = $actQuery->rowCount() ? $actQuery->fetchAll(PDO::FETCH_ASSOC) : [];
